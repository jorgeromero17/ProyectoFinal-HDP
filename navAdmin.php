            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="comentariosNuevos.php"><i class="fas fa-comment-dots me-2"></i>Comentarios Nuevos</a></li>
                        <li><a class="dropdown-item" href="comentariosRechazados.php"><i class="fas fa-comment-slash me-2"></i>Comentarios Rechazados</a></li>
                        <li class="nav-item">
