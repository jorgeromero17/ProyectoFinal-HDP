        ...
        <div class="contenido-post overflow-auto mt-4" style="border-radius:10px;border:1px solid #262b47;padding:0;height:400px;">
                ...
                foreach ($res as $row){
                    ...
                    echo <<<END
                            ...
                            <div class="mt-3">
                                <span>En: $titulo_post</span>
                            </div>
                            <div class="d-flex justify-content-end">
                                <button type="button" class="btn mx-2" style="background:#white;font-weight:600;border:1px solid #554dde;color:#554dde;">Rechazar</button>
                                <button type="button" class="btn text-light mx-2" style="background:#554dde;font-weight:600;">Agregar</button>
                            </div>
                        </div>
                    END;
                    }
