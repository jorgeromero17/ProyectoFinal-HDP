...
<div class="container">
    ...
    <!-- <p class="h5 mt-4 mx-auto" style="width:90%;">Moderar Comentarios</p>  --> 
        <div class="overflow-auto mt-4" style="padding:0;height:600px;background:f5f5f5">
                ...
                $query="SELECT * FROM coments WHERE aprobado=0";               
                ...
                if(count($res) < 1){
                    echo '<div class="alert alert-warning d-flex aling-content-center" role="alert">
                            <i class="fas fa-search me-2" style="font-size:25px;"></i><strong>No hay comentarios nuevos</strong>
                        </div>';
                }
                else{
                    ...
                    foreach ($res as $row){
                        ...
                        echo <<<END
                                ...
                                <div action="agregar" class="d-flex justify-content-end">
                                    <a type="button" href="comentarios.php?id=$id&mod=2" class="btn mx-2" style="background:#white;font-weight:600;border:1px solid #554dde;color:#554dde;">Rechazar</a>
